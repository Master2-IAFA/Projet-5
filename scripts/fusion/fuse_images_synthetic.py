...
def parse_args():
    ...
    parser.add_argument('--run_fusion', dest='run_fusion', action='store_true', default=True,
                        help='if set, full fusion will be launched; if not set, only GT, predictions, and diff will be saved.')

    parser.add_argument('-ssv', '--save_single_views', action='store_true', default=True, dest='save_single_views',
